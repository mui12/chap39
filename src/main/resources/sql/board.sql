...
UPDATE board SET created = NULL WHERE bno = 26;
...
VALUES (2, 'jane456', 'password2', 'Question about topic', 'I have a question about a specific topic. Can someone help me?');
INSERT INTO board (bno, id, pwd, email, subject, content)
VALUES (3, 'alex789', 'password3', 'alex@example.com', 'Recommendation needed', 'I need recommendations for a good book to read.');
INSERT INTO board (bno, id, pwd, subject, content)
